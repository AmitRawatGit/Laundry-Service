...
function Orders() {
    ...
    async function cancelOrder(id){
            try{
            await fetch(`http://localhost:3070/orders/cancelorder/${id}`,{
                        ...
                        <div className="modal-content summary-content">
                            <div className="modal-header">
                                ...
                                <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                    ...
                                    <div className="modal-body">
                                        <div className="store">
                                            <div className='storeloc'><span>Store Location</span><br />Street 283</div>
                                            <div className='storeadd'><span>Store Address</span><br />New Town, Kolkata</div>
                                            <div className='storephone'><span>Phone</span><br />91 7719558697</div>
                                        </div>
                                        ...
                                        <div className='details'>
                                            ...
                                            <div className='total' ><b className='final'>Total:   Rs {orders[currindex].items.reduce((acc,curr)=> acc+parseInt(curr.price),0)+90}</b></div>
                                        </div>
                                        <div className='addressbar'><small className='orderdetails'>Address</small>
                                        <div className='address1'>
                                            <b className='numbers'>Home</b><br />
                                            Street 283, New Town, Kolkata
                                        </div>
                                        </div>
