...
function Header(){
  ...
  <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
    <li><span className="dropdown-item" ><small className='explore'>Explore</small></span></li>
    <li><span className="dropdown-item" > <small className='about'>About us</small></span></li>
